module.exports = function(grunt){
		...
		copy: {
			main: {
				...
				// includes files within path and its sub-directories
				{
					expand: true,
					cwd: 'source',
					src: ['*', 'js/build/app.min.js', 'js/vendor-non-build/**', 'includes/*', 'img/*', 'css/**', '!Gemfile', '!js/vendor-build', '!.sass-cache', '!img/source'],
					filter: 'isFile',
					dest: 'build/'
				}],
			},
	 ...
	 *
	 */
	grunt.registerTask('default', ['clean', 'compass', 'bower_concat', 'concat', 'uglify', 'imagemin', 'copy', 'string-replace']);
